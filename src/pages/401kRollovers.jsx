        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12">
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-2xl font-semibold text-customGray mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Ability to Add Money</h3>
                    <p className="text-customGray text-sm">Once you leave your employer, you generally won't be able to add money to your plan.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Investment Choices</h3>
                    <p className="text-customGray text-sm">401(k) plans typically have a more limited number of investment options compared to an IRA but may include investments you can't get through an IRA.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Available Services</h3>
                    <p className="text-customGray text-sm">Some plans may offer educational materials, planning tools, telephone help lines and workshops. Your plan may or may not provide access to a financial advisor.</p>
                  </div>
                </div>

                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Fees and Expenses</h3>
                    <p className="text-customGray text-sm">401(k) fees and expenses often include administrative fees, investment-related expenses, and distribution fees. These fees and expenses may be lower than the fees and expenses of an IRA.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Penalty-free Distributions</h3>
                    <p className="text-customGray text-sm">Generally, you can take money from your plan without tax penalties at age 55, if you leave your employer in the calendar year you turn 55 or older.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Required Minimum Distributions</h3>
                    <p className="text-customGray text-sm">Generally, you must take minimum distributions from your former employer's plan beginning at age 72.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Required Minimum Distributions</h3>
                    <p className="text-customGray text-sm">Generally, you must take minimum distributions from your plan beginning at age 72, unless you are still working at the company.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Ability to Add Money</h3>
                    <p className="text-customGray text-sm">You should be able to add money to your IRA, as long as you meet certain income requirements. This allows you to consolidate your retirement and other accounts, which may make it easier to monitor your investments and simplify account information at tax time.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Investment Choices</h3>
                    <p className="text-customGray text-sm">Traditional and Roth IRAs typically have a broader range of investment options than employer plans, but you may not have access to the same investments that are in your plan.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Available Services</h3>
                    <p className="text-customGray text-sm">Through our face-to-face approach to serving clients, your financial advisor can help you identify and implement strategies to help you reach your financial goals.</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Fees and Expenses</h3>
                    <p className="text-customGray text-sm">IRA fees generally include an annual account fee, investment-related expenses, and termination fees. For the current fee schedule, contact your financial advisor.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Penalty-free Distributions</h3>
                    <p className="text-customGray text-sm">Generally, you can take money from IRA without tax penalties at age 59 ½.</p>
                  </div>

                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-customGray mb-2">Required Minimum Distributions</h3>
                    <p className="text-customGray text-sm">Generally, you must take minimum distributions from a traditional IRA beginning at age 72.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            ...
            <p className="text-customGray mb-6 text-lg">
