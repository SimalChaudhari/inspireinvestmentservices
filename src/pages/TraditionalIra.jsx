      ...
      <div className="bg-white py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed font-lora">
          ...
          <div className="mb-12 sm:mb-16">
            ...
            <div className="space-y-4 text-lg text-gray-600 leading-relaxed font-lora">
              <p>
          ...
          <div className="mb-12 sm:mb-16">
            ...
            <div className="bg-gray-50 rounded-lg p-8 sm:p-10">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-6 font-lora">
                If you are:
              </h3>
          ...
          <div className="mb-12 sm:mb-16">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-r-lg">
                <h3 className="text-xl font-bold text-gray-800 mb-4 font-lora">
                  Penalties
                </h3>
